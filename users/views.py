...
from .utils import searchProfile,paginatprofiles
...
def userProfile(request, pk):
    ...
    topskill = profiles.skills_set.exclude(description__exact="")
...
def createMessage(request, pk):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.success(request, 'Your Message is succesfully sent')
